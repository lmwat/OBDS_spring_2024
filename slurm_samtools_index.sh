...
samtools view --threads 12 -b -h ./mapped_reads/ERR1755082.sam > ./mapped_reads/ERR1755082.bam
samtools sort ./mapped_reads/ERR1755082.bam > ./mapped_reads/ERR1755082_sorted.bam
samtools index ./mapped_reads/ERR1755082.bam
